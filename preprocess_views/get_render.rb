...
class Render_stmt
	...
	attr_accessor :is_default, :is_layout, :astnode, :action, :render_file, :locals, :collection, :as, :properties, :object
	def get_content
	...
	def parse_render
		...
		# extract objects:
		object_node = parse_render_variables(@astnode, 'object')
		if object_node
			object = object_node.source.split("=>")[-1].lstrip
			if object 
				@object = object
			end
		end
